...
<body>
    <section class="bg-white dark:bg-gray-900 h-screen" style="background-image: url('{{ asset('assets/logo/logo.png') }}'); background-position: center 70%;background-repeat: no-repeat;">
